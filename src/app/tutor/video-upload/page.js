        ...
        <div className='relative w-[90%] lg:w-4/6 mx-auto mt-16'>
            ...
            <div className='flex flex-col gap-4'>
                {[...Array(videoBodies)].map((_, index) => (
                    <>
                        <div className={`h-[2px] relative w-[84%] lg:w-full bg-[#1850BC] ${videoBodies > 1 ? "block" : "hidden"}`}>
            ...
            <div className='flex justify-center mt-4 mb-16'>
                <button onClick={handleAddVideoBody} className=' text-white plus'><Image src={"/svgs/add_video.svg"} width={35} height={35} /></button>
            </div>
        </div>
    )
}
          ...
          {videoUrl ? (
            ...
            <>
              <div className='flex gap-2'>
                Upload Video <Image src={"/svgs/upload_video.svg"} width={15} height={15} alt='file' />
              </div>
            </>
          )}
          <input
