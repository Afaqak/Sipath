        ...
        <div className='mt-8 relative '>
          ...
          <div className='bg-white  py-2 shadow-sm'>
            <div className='flex gap-2 py-1 items-center justify-center'>
              <input className='rounded-md py-1 focus:outline-none w-[70%] placeholder:text-sm shadow-[inset_1px_4px_10px_rgba(0,0,0,0.1)] px-2' placeholder='Type here...' type='text' />
              <button><Image src={"/svgs/send.svg"} width={30} height={30} /></button>
            </div>
          </div>
        </div>
      </div>
