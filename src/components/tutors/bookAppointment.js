      ...
      <div className='max-h-[80vh] overflow-y-scroll'>
        <div className='bg-white px-6 w-full md:w-fit py-4 rounded-md  shadow-md'>
          ...
          <div className='flex flex-col items-center= mt-2'>
            ...
            <button onClick={() => setAppointment(false)} className='text-center mt-4 font-semibold'>Cancel</button>
          </div>
        </div>
      </div>
    </div>
            ...
            <div className='flex gap-2 items-center justify-center'>
              {['AM', 'PM'].map((period) => (
                <div key={period} className='flex flex-col'>
                  ...
                  <label onClick={() => setCheckedTime(period)} className='inline-flex items-center cursor-pointer'>
