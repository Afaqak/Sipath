...
export function AppointmentRequestModal({ isOpen, setIsOpen,userId}) {
  ...
  return (
    <div
      className={`fixed inset-0 overflow-y-auto z-[100000] transition-opacity ${
    ...
    >
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
          ref={ref}
          className={`inline-block relative z-[5000] align-bottom bg-white rounded-lg p-4 text-left shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full ${
              ...
              <div className="bg-white">
                <div className="mb-2 ">
                  ...
                  <DatePicker
                    ...
                    customInput={<CustomInput ref={dateRef} />}
