...
export const PodcastFeed = ({ title, avatar, sender, btnTxt, desc, price }) => {
  return (
    <div className="flex flex-col px-4 pt-4 pb-3 bg-white shadow-md rounded-md mb-4 relative">
      <div className={`flex md:flex-row flex-col  ${avatar ? 'gap-4' : 'gap-0'}`}>
        <div className="">
        ...
        <div className="flex flex-col relative">
          <div className="flex gap-2 flex-col">
            ...
            <p className="md:w-[90%] text-sm md:text-base mb-1">{desc}</p>
          </div>
      ...
      <div className="flex md:flex-row flex-col justify-between mt-4">
        ...
        <div className="flex gap-4 items-center ">
          ...
          <button className="px-8 hover:bg-gray-700 hover:text-white transition-all duration-100 ease-in-out py-1 rounded-md border-gray-700 border-2 w-full md:mt-0 mt-3">
            {btnTxt}
          </button>
        </div>
      </div>
