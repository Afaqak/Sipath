...
//                       placeholder="First Name"
//                       type="text"
//                       className="shadow-[inset_2px_1px_6px_rgba(0,0,0,0.2)] placeholder:text-[#CDCBCB] rounded-md px-4 py-2 placeholder:text-sm border-none focus:outline-none"
//                       name="firstName"
//                     />
//                     {errors.firstName && (
//                       <span className="text-red-500 text-sm mt-1 lowercase">
...
//                         <button
//                           className={cn(
//                             'shadow-[inset_2px_1px_6px_rgba(0,0,0,0.2)] text-left rounded-md px-4 py-2 '
//                           )}
//                         >
//                           {
//                             <span className={`text-sm ${!date ? 'text-[#CDCBCB]' : 'text-black'}`}>
...
//                     rows={4}
//                     cols={4}
//                     className="placeholder:text-sm py-2 placeholder:text-[#CDCBCB] resize-none focus:outline-none shadow-[inset_2px_1px_6px_rgba(0,0,0,0.2)] px-4 rounded"
//                     placeholder={'Bio'}
//                   />
//                   {errors.bio && (
//                     <span className="text-red-500 text-sm mt-1 lowercase">
...
//                     placeholder="Choose a Display Name"
//                     type="text"
//                     className="shadow-[inset_2px_1px_6px_rgba(0,0,0,0.2)] placeholder:text-[#CDCBCB] w-full rounded-md px-4 py-2 placeholder:text-sm border-none focus:outline-none"
//                     name="displayName"
//                   />
//                   {errors.displayName && (
//                     <span className="text-red-500 text-sm mt-1 lowercase">
