...
export const ExpertItem = ({ item }) => {
  return (
    <>
      <div
        className={`relative mb-6 flex flex-col lg:pl-14 items-center lg:items-start h-fit lg:h-40 py-6 w-[22rem] bg-white box-shadow-main rounded-sm mt-6 md:mt-2`}
      >
        ...
        <div className="mt-4 lg:mt-0">
          <div className="mb-2">
            <div>
              ...
              <div className="text-[0.8rem] flex items-center lg:justify-normal lg:gap-4 gap-2 justify-between">
                <p className="font-medium text-[#616161]">
                  {item && item['user.follower_count']} followers
                </p>
          ...
          <p className="break-all font-light text-gray-400 line-clamp-3 text-sm">
            {item && item['user.bio']}
          </p>
        </div>
      </div>
