...
import { VideoEditModal } from './editModal';
...
export const VideoItem = ({ video }) => {
  ...
  return (
    <div className="h-[20rem] relative block w-full p-4 bg-white shadow-md rounded-md">
          ...
          <div className="w-full flex justify-between items-start">
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="bg-white rounded-md shadow-md p-2 w-24 absolute top-8 right-0"
              >
      ...
      <VideoEditModal isOpen={open} setIsOpen={setOpen} />
    </div>
  );
};
