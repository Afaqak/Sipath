...
export const FeedSkeleton = ({ time }) => {
  return (
    <div className='flex gap-6 flex-col w-full mx-auto'>
      {
        [...Array(time)].map((t,ind) => (
          <div key={ind} className="flex flex-col md:w-[70%] w-[90%] lg:w-[50%] mx-auto px-4 pt-4 pb-3 bg-white shadow-md rounded-md">
...
export const CategoriesSkeleton = ({ time }) => {
  return (
    <div className='flex gap-6 w-full mx-auto'>
      {
        [...Array(time)].map((t,ind) => (
          <div key={ind} className="flex flex-col gap-4 h-[14rem] md:w-[70%] w-[90%] lg:w-[50%] mx-auto px-4 pt-4 pb-3 bg-white shadow-md rounded-md">
